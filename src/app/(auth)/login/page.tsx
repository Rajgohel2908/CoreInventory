      ...
      <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}
        ...
        <div style={{ width: "100%", maxWidth: "400px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "40px" }}>
            <div className="logo react" style={{ width: "40px", height: "40px", borderRadius: "var(--radius-lg)", background: "var(--color-primary)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, color: "#fff", cursor: "pointer" }}>CI</div>
            <span className="logo react" style={{ fontSize: "20px", fontWeight: 700, color: "var(--color-text-primary)", display: "inline-block", cursor: "pointer" }}>CoreInventory</span>
          </div>
